...
다양한 직군과 맥락을 나누며 비즈니스 문제를 제품으로 풀어내는 걸 좋아해요.  
하드 스킬만큼 소프트 스킬의 힘을 믿고,  
작은 팀에서 아이디어부터 배포·운영까지 직접 책임지는 모든 과정을 즐겨요.

<br/>

**🔭 Currently**

🤖 Hermes Agent 활용한 AI 에이전트 자동화 실험 중  
🌱 AI Native 개발 패턴 & 툴링 리서치 중
